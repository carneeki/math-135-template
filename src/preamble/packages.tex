...
\usepackage{graphicx}      % include jpg, png, pdf as figures
...
\usepackage{color}
\usepackage[table]{xcolor} % colour map
...
\usepackage{soul}    % used for Memoir chapter style
\usepackage{fourier} % used for Memoir chapter style
\usepackage{calc}    % used for Memoir chapter style