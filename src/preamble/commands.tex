...
% from http://www.cse.iitd.ernet.in/~anup/homepage/UNIX/latex.html#watermark
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\banana}{\rotatebox[origin=c]{-60}{\Moon}}
...
{\newcommand\colboxcolor{FFEFEF}%
\begin{lrbox}{\bigideabox}%
\begin{minipage}{\dimexpr\columnwidth-2\fboxsep\relax} \textbf{Big Ideas:} } {\end{minipage}\end{lrbox}%
\begin{center}
  \colorbox[HTML]{\colboxcolor}{\usebox{\bigideabox}}
\end{center}}

\newsavebox{\rememberbox}
\newenvironment{remember}[1]
{\newcommand\colboxcolor{FFEFEF}%
\begin{lrbox}{\rememberbox}%
\begin{minipage}{\dimexpr\columnwidth-2\fboxsep\relax} \textbf{#1:}} {\end{minipage}\end{lrbox}%
\begin{center}
  \colorbox[HTML]{\colboxcolor}{\usebox{\rememberbox}}
\end{center}}